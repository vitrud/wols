...
function touch_html_head_alter(&$head_elements) {
  ...
  drupal_add_js('sites/all/themes/touch/js/class-extend.js', array('type' => 'external'));
  drupal_add_js('sites/all/themes/touch/js/slider.js', array('type' => 'external'));
}
...
function touch_search_theme_form($form)
{
